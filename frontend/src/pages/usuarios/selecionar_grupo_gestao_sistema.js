...
export default function SelecionarGrupoGestaoSistema() {
    ...
    const handleSelect = (grupo) => {
        ...
        if (grupo==="externo"|| grupo === "responsavel"){
        ...
        <div>
            <main className="container escolha-grupo">
                ...
                <div className="grid-opcoes">
                    <button onClick={() => handleSelect("externo")} className="link_botao_escolha ">
                        <i class="bi bi-person-plus"></i>Usuario Externo
                    </button>
                    <button onClick={() => handleSelect("responsavel")} className="link_botao_escolha ">
                        <i class="bi bi-person-plus-fill"></i>Responsavel
                    </button>
