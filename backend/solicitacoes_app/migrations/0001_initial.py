# Generated by Django 5.0.3 on 2025-05-19 22:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('solicitacao_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='solicitacoes_app.solicitacao')),
                ('aluno_nome', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Nome do Aluno')),
                ('email', models.EmailField(max_length=254, validators=[django.core.validators.EmailValidator()], verbose_name='E-mail')),
                ('matricula', models.CharField(max_length=20, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Matrícula')),
                ('componentes_curriculares', models.TextField(verbose_name='Componentes Curriculares')),
