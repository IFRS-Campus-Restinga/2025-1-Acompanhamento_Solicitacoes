...
from solicitacoes_app.serializers.forms.form_abono_falta_serializer import FormAbonoFaltaSerializer
from solicitacoes_app.serializers.forms.form_exercicios_domiciliares import FormExercicioDomiciliarSerializer
from solicitacoes_app.serializers.forms.form_disp_ed_fisica_serializer import FormDispEdFisicaSerializer
from solicitacoes_app.serializers.forms.form_tranc_disciplina_serializer import FormTrancDisciplinaSerializer
from solicitacoes_app.serializers.forms.form_desistencia_vaga_serializer import FormDesistenciaVagaSerializer
from solicitacoes_app.serializers.forms.form_tranc_matricula_serializer import FormularioTrancamentoMatriculaSerializer
from solicitacoes_app.serializers.forms.form_entrega_ativ_compl_serializer import FormEntregaAtivComplSerializer
